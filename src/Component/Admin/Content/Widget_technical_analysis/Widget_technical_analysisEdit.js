...
import {
  saveWidget_technical_analysiss,
  getWidget_technical_analysis
} from "../../../../Services/Widget_technical_analysis/widget_technical_analysis";
//import { showAlertMSG } from "../../../../Lib/helpers";

function Widget_technical_analysisEdit(props) {
  ...
  const getWidget_technical_analysisData = async () => {
    let retData = await getWidget_technical_analysis(props.data);
    if (retData !== null) {
  ...
  useEffect(() => {
    if (props.data !== 0) {
      getWidget_technical_analysisData(props.data);
    }
  }, []);
  ...
  const saveData = () => {
    ...
    saveWidget_technical_analysiss(data);
  };
  return (
...
export default Widget_technical_analysisEdit;
