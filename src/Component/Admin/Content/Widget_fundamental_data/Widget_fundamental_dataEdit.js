...
import {
  saveWidget_fundamental_datas,
  getWidget_fundamental_data
} from "../../../../Services/Widget_fundamental_data/widget_fundamental_data";
//import { showAlertMSG } from "../../../../Lib/helpers";

function Widget_fundamental_dataEdit(props) {
  ...
  const getWidget_fundamental_dataData = async () => {
    let retData = await getWidget_fundamental_data(props.data);
    if (retData !== null) {
  ...
  useEffect(() => {
    if (props.data !== 0) {
      getWidget_fundamental_dataData(props.data);
    }
  }, []);
  ...
  const saveData = () => {
    ...
    saveWidget_fundamental_datas(data);
  };
  return (
...
export default Widget_fundamental_dataEdit;
