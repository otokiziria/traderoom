...
import {
  saveWidget_economic_calendars,
  getWidget_economic_calendar
} from "../../../../Services/Widget_economic_calendar/widget_economic_calendar";
//import { showAlertMSG } from "../../../../Lib/helpers";

function Widget_economic_calendarEdit(props) {
  ...
  const getWidget_economic_calendarData = async () => {
    let retData = await getWidget_economic_calendar(props.data);
    if (retData !== null) {
  ...
  useEffect(() => {
    if (props.data !== 0) {
      getWidget_economic_calendarData(props.data);
    }
  }, []);
  ...
  const saveData = () => {
    ...
    saveWidget_economic_calendars(data);
  };
  return (
    <div style={{ backgroundColor: "#fff" }}>
      <form>
        ...
        <div className="form-group">
          <label htmlFor="for_light_content">Light Widget Data</label>
          <textarea
        ...
        <div className="form-group">
          <label htmlFor="for_dark_content">Dark Widget Data</label>
          <textarea
...
export default Widget_economic_calendarEdit;
